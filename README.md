# 💡 MultiHop-RAG
Studying MultiHop-Relational Attribute Graph) is a technique used for modeling complex relationships between entities in large-scale knowledge graphs. LLMs (Language Models) refer to a class of machine learning models trained on large amounts of textual data, capable of understanding and generating human-like text
